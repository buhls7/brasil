...
//------> vorläufig manuell anpassen     
    public static final TeamProtos.Team TEAM = TeamProtos.Team.MAGENTA;
    private final int FIELDHALF = NORTH;   // CYAN is SOUTH  // MAGENTA is NORTH
...
//Index Constants for Way-Arrays
  ...
  // Startkoordinaten der einzelnen Robos  
    ...
    private JobController() throws AWTException
    {
            ...
            {   //Matches this product ?            
                ...
                {   //more Products needed ? 
                    ...
                    {   //is the delivery gate already open
                        if (order.getDeliveryPeriodBegin() <= hnd.game.getGameTime().getSec())
