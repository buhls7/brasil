...
// ------------------------- BeaconInfo ----------------------------------------
  ...
  private int seq;                    // Sequenz für Beacon
// ---------------------------- Verbindung -------------------------------------
...
// ---------------------------- MachineReport ----------------------------------
  ...
  public Handler(ProtobufBroadcastPeer peer) throws AWTException
  {
    this.peer = peer;
...
// ------------------ Array[15] füllen: Station 1 - 3 platz 0 - 2... -----------
  ...
  public static void main(String[] args) throws AWTException
  {
    ...
    {
      Logger.getLogger(HandlerOld.class.getName()).log(Level.SEVERE, null, ex);
    }
  }
